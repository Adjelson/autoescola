...
$id = $_GET['id'];
$stmt = $conn->prepare("SELECT * FROM pedidos_exame WHERE id = ? AND tipo = 'extra'");
$stmt->execute([$id]);
$pedido = $stmt->fetch();
